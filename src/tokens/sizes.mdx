...
export const filterTokensByType = (type) =>
...
export const filteredSizeTable = generateTokenTable(
  Object.keys(sizeTokens)
    .filter((key) => !ignoreTypes.includes(sizeTokens[key].attributes.type))
    .map((key) => sizeTokens[key]),
);
export const radiusTable = generateTokenTable(filterTokensByType('border'));
export const edgeTable = generateTokenTable(filterTokensByType('edge'));
export const paddingTable = generateTokenTable(filterTokensByType('padding'));
export const rhythmTable = generateTokenTable(filterTokensByType('rhythm'));
export const spacingTable = generateTokenTable(filterTokensByType('spacing'));
