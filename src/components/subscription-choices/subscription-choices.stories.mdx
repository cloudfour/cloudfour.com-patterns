...
JavaScript can be used to enhance the UX for the Subscription Choices component
by adding a form hide delay when `:focus` is moved away from the
Subscription Choices component elements.
...
The Subscription Choices component `.js-subscription-choices` root element.
