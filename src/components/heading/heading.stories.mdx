...
There are some instances where the heading weight is lighter than the default `font-weight.$bold`, this modifier will set the font weight to `font-weight.$light`.
