...
| property                                 | type   | default                                 | description                                                                                                                   |
| ---------------------------------------- | ------ | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `class`                                  | string | `''`                                    | Appends a CSS class(es) to the root `.c-subscription-choices` element.                                                        |
...
JavaScript is required for the Subscription Choices component to work.

### Syntax

```js
initSubscriptionChoices(subscriptionChoicesEl);
```
...
The `.js-subscription-choices` Subscription Choices wrapper element.
...
#### Single Subscription Choices component on the page

```js
// Initialize
const subscriptionChoicesEl = initSubscriptionChoices(
...
#### Multiple Subscription Choices components on the page

```js
// Initialize
const subscriptionChoiceEls = [
  ...document.querySelectorAll('.js-subscription-choices'),
].map((subscriptionChoiceEl) => initSubscriptionChoices(subscriptionChoiceEl));
...
You will also need to initialize the "Get Notifications" [Button Swap component](?path=/docs/components-button-swap--default-story#javascript).
