...
Additionally, the message pattern should be used thoughtfully and sparingly for only the most important information.
...
Messages should almost always be dismissable. 
