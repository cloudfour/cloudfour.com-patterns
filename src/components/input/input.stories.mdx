...
Add the `c-input--elastic` modifier class to a `<textarea>` element (and follow the [JS usage notes](#javascript-usage)) to have it expand as the user types more than will fit.
