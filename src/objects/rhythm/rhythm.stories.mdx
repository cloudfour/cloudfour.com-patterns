...
Nested rhythm objects will inherit any spacing set via modifiers. In this example, the first list inherits the parent element's rhythm while the second resets it using the `default` amount:
