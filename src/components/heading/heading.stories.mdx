...
import weightDemo from './demo/weight.twig';
...
There are some instances where the heading weight is lighter than the default `700`, this modifier will set the font weight to `300`.
    ...
    parameters={{
      docs: {
        source: {
          code: `{% include '@cloudfour/components/heading/heading.twig' with {
  weight: 'light',
  content: 'c-heading--weight-light',
} only %}`,
        },
      },
    }}
