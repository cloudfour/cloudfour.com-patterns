...
- The `<header>` element includes a `role` attribute of `banner` because [it is not a direct child of the `<body>` element](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/Banner_Role).
