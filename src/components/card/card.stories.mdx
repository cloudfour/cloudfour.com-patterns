...
// See comment above about Webpack-specific syntax
// eslint-disable-next-line @cloudfour/import/no-webpack-loader-syntax
import logoDemoSource from '!!raw-loader!./demo/logo.twig';
import logoDemo from './demo/logo.twig';
  ...
  >
    {() =>
      logoDemo({
        logos: [
          {
            url: '/media/logos/walmart.svg',
            alt: 'Walmart',
            width: 176,
            height: 42,
          },
          {
            url: '/media/logos/baptist.svg',
            alt: 'Baptist Health',
            width: 415,
            height: 74,
          },
          {
            url: '/media/logos/cpe.svg',
            alt: 'Champion Power Equipment',
            width: 190,
            height: 80,
          },
          {
            url: '/media/logos/pleasantest.svg',
            alt: 'Pleasantest',
          },
          {
            url: '/media/logos/ceasefire.svg',
