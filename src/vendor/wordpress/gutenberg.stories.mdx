...
This block creates a `div` with class `wp-block-file`, which wraps a single
`a` element. Links can either be configured to download the linked media or or open in a new tab. If this ()

, the second of which (toggled in the editor) is meant to be styled
...
<Preview>
  <Story name="core/file">
    {`<div class="wp-block-file">
      ...
      <div class="wp-block-file">
        <a href="#">default download link</a>
      </div>
    `}
  </Story>
</Preview>
