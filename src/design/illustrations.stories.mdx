...
import responsiveImage from '../assets/illustrations/test.svg';
...
An SVG that's used as a fallback image by our service worker when an image request fails.
...
We should craft a new image that's more consistent with those feature images but fulfills the purpose of the service worker fallback.

<Story name="Test" height="200px">
  {`
  <div style="display: flex; gap: 1em; justify-content: center; flex-wrap: wrap; align-items: center;">
  <img src="${responsiveImage}" alt="Responsive fallback image" style="aspect-ratio: 16 / 9; height: 15em;">
  <img src="${responsiveImage}" alt="Responsive fallback image" style="aspect-ratio: 9 / 16; height: 15em;">
  <img src="${responsiveImage}" alt="Responsive fallback image" style="aspect-ratio: 1 / 1; height: 15em;">
  </div>
  `}
</Story>
