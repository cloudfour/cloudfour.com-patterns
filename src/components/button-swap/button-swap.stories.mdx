...
- `content_start_icon` (string, default `'bell'`): Blah...
- `first_button_visually_hidden_text` (string, default `'Unsubscribed from notifications'`): The visually hidden message when the first button is visible.
- `first_button_label` (string, default `'Get notifications'`): Blah
- `second_button_visually_hidden_text` (string, default `'Subscribed to notifications'`): blah
- `second_button_label` (string, default `'Turn off notifications'`): blah
