...
export const generateTokenTable = (props, filterLevel) => {
...
export const easeTable = generateTokenTable(tokens.ease, 'category');
export const speedTable = generateTokenTable(tokens.time.transition, 'type');
export const scaleTable = generateTokenTable(
  tokens.number.scale.effect,
  'type',
);
export const brightnessTable = generateTokenTable(
