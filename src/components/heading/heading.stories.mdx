...
<Canvas isColumn>
  <Story name="Default weight" args={{ content: 'Default weight' }}>
    {(args) => demo(args)}
  </Story>
  <Story
    name="Light weight"
    args={{ weight: 'light', content: 'Light weight with <b>bold</b> word' }}
  >
    {(args) => demo(args)}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Permalink" args={{ permalink: true, id: 'permalink-example' }}>
    {(args) => demo(args)}
  </Story>
</Canvas>
