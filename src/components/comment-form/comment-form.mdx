...
import * as CommentFormStories from './comment-form.stories.js';

<Meta of={CommentFormStories} />
...
<Canvas of={CommentFormStories.Default} />
...
<Canvas of={CommentFormStories.Reply} />
