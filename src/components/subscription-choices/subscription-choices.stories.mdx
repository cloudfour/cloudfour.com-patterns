      ...
      docs: {
        source: {
          code: makeTwigInclude(
            '@cloudfour/components/subscription-choices/subscription-choices.twig',
            {
              form_id: 'example-demo',
            }
          ),
...
The Subscription Choices component UX can be progressively enhanced by adding
a 1 second form hide delay when `:focus` is moved away from the Subscription
Choices component elements.
